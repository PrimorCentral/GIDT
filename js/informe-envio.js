...
function celdaCentrada(contenidoHtml, colorTexto, estiloExtra = '') {
  return `<table role="presentation" width="100%" height="100%" cellpadding="0" cellspacing="0" border="0"><tr><td align="center" valign="middle" style="padding:8px 0; mso-line-height-rule:exactly; line-height:20px; font-size:14px; color:${colorTexto}; ${estiloExtra}">${contenidoHtml}</td></tr></table>`;
}
