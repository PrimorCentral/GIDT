...
function tablaHtmlIncidencias(filas) {
  const th = 'text-align:left; padding:5px 12px; background:#f8fafc; color:#64748b; font-size:11px; text-transform:uppercase; letter-spacing:.3px; border-bottom:1px solid #e2e8f0;';
  const td = 'padding:3px 12px; border-bottom:1px solid #f1f5f9; font-size:12.5px; color:#475569; line-height:1.25;';
